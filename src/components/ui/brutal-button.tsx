...
const brutalButtonVariants = cva(
  "inline-flex items-center justify-center font-bold text-base transition-transform duration-100 border-2 border-foreground cursor-pointer select-none disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
